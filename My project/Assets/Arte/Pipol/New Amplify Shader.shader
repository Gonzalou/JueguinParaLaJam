...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		_Color1("Color 1", Color) = (0.4150943,0.4150943,0.4150943,1)
		_Color2("Color 2", Color) = (0,0.153555,0.8301887,1)
		_Color0("Color 0", Color) = (0.7830189,0.7830189,0.7830189,1)
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 lerpResult4 = lerp( float4( 0,0,0,0 ) , _Color0 , tex2DNode1.r);
				float4 lerpResult5 = lerp( float4( 0,0,0,0 ) , _Color1 , tex2DNode1.g);
				float4 lerpResult6 = lerp( float4( 0,0,0,0 ) , _Color2 , tex2DNode1.b);
...
/*ASEBEGIN
Version=17200
231.2;348;930.4;371;1807.386;591.1558;2.813584;True;False
...
Node;AmplifyShaderEditor.ColorNode;10;-609.6912,328.6933;Inherit;False;Property;_Color2;Color 2;2;0;Create;True;0;0;False;0;0,0.153555,0.8301887,1;0,0.153555,0.8301887,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;9;-608.5607,98.29979;Inherit;False;Property;_Color1;Color 1;1;0;Create;True;0;0;False;0;0.4150943,0.4150943,0.4150943,1;0.4150943,0.4150943,0.4150943,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;8;-531.5592,-143.3475;Inherit;False;Property;_Color0;Color 0;3;0;Create;True;0;0;False;0;0.7830189,0.7830189,0.7830189,1;0.7830189,0.7830189,0.7830189,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;34;-792.0302,-254.354;Inherit;True;Step Antialiasing;-1;;3;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0.17;False;2;FLOAT;0.66;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=D162475D2DEF2A5F142905AEC7B5DF967828F693